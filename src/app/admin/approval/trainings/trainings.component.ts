...
import { ARCHIVE_DOCUMENT, GENERATE_URL, GET_DOCUMENTS, GET_TRAININGS, REFUSE_DOCUMENT, UPDATE_DETAILS, UPDATE_DOCUMENT, UPDATE_USER, VALIDE_DOCUMENT } from 'src/graphql/approval';
