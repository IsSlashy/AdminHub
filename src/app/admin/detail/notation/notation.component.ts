...
export class NotationComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.noteForm = this.formBuilder.group({
      averageNote: ['', [Validators.required, Validators.min(0), Validators.max(5)]],
      noteSkill: ['', [Validators.required, Validators.min(0), Validators.max(5)]],
      noteRespect: ['', [Validators.required, Validators.min(0), Validators.max(5)]],
      noteCommunication: ['', [Validators.required, Validators.min(0), Validators.max(5)]],
